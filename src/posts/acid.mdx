...
slug: '/blog/p/acid'
category: ['RDBMS']
coverImage: 'https://www.dbta.com/Images/Default.aspx?ImageID=19031&max=1080&maxWidth=1080&canvas1080x1020'
---
...
只要儲存硬體沒有受損，commited transaction 的數據會**永久**保存到磁碟上。

為了確保資料的持久性，postgresql 使用了 Write-Ahead Logging (WAL)[^3] 機制。這意味著在寫入數據之前，postgresql
