...
excerpt: 之前在紀錄 ORM 時有提到為了避免 N+1，可以用 GROUP BY 來避免。因為 GROUP BY 很常在 SQL 中使用，所以是應該好好記下來才行。
slug: '/blog/p/sql-group-by'
category: ['sql']
...
![Imgur](https://i.imgur.com/nxXoTuQ.png?w=800&pt=60&pb=60)
