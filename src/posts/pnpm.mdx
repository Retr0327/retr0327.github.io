...
1. [深入淺出 npm - yarn - pnpm 包管理機制](https://www.readfog.com/a/1673072431709917184)
2. [關於依賴管理的真相— 前端包管理器探究](https://mp.weixin.qq.com/s/CYQQKvy9MaGHdpSHpBJwzw)
3. [關於現代包管理器的深度思考——為什麼現在我更推薦 pnpm 而不是 npm/yarn?](https://juejin.cn/post/6932046455733485575)
4. [PNPM - Motivation](https://pnpm.io/motivation)
5. [NPM 中的 phatom 與 doppelgangers 問題](https://zhuanlan.zhihu.com/p/353208988)
