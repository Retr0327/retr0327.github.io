...
export const metadata = {
  ...
  excerpt:
    '這篇想要記錄的是我在學 design patterns (設計模式) 的過程時，常常分不清 dependency injection 和 dependency inversion 之間的關係。因此借機寫成一個 blog，幫自己重新了解一次。',
  category: ['design pattern'],
  coverImage:
    'https://stackify.com/wp-content/uploads/2018/06/Design-Patterns-Explained-%E2%80%93-Dependency-Injection-with-Code-Examples.png',
};
...
![di-dip-relationship](https://www.tutorialsteacher.com/Content/images/ioc/principles-and-patterns.png?pt=20&pb=20)
